...
show(imsegmout,1);title('Raw image');axis off;
show(cellbw1,1);title('Cell segmentation by ADTH');axis off;

% improving the results by splitting of cells
splitth = 1;
plane = 1;
cellbw2 = cellsegm.splitcells(cellbw1,splitth,plane);
show(cellbw2,2);title('Cell segmentation by ADTH with splitting');axis off;
...
show(cellbw3,3);title('Cell segmentation by THRS');axis off;

% improving the results by splitting of cells
splitth = 1;
plane = 1;
cellbw4 = cellsegm.splitcells(cellbw1,splitth,plane);
show(cellbw4,4);title('Cell segmentation by ADTH with splitting');axis off;